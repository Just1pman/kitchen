                                ...
                                <div class="hero-slide">
                                    <div class="hero-slide-info">
                                        <?php if (!empty($slide['label'])) : ?>
                                            <p class="hero-slide-info-label"><?= $slide['label'] ?></p>
                                        <?php endif; ?>
                                        <?php if (!empty($slide['headline'])) : ?>
                                            <h1 class="hero-slide-info-headline"><?= $slide['headline'] ?></h1>
                                        <?php endif; ?>
                                        <?php if (!empty($slide['subheadline'])) : ?>
                                            <p class="hero-slide-info-subheadline"><?= $slide['subheadline'] ?></p>
                                        <?php endif; ?>
                                        <?php if (!empty($slide['link'])) : ?>
                                            <a href="<?= $slide['link']['url'] ?? '#' ?>"
                                               class="hero-slide-info-link button" <?php if ($slide['link']['target']) : ?> target="_blank" <?php endif; ?> >
                                                <?= $slide['link']['title'] ?? '' ?>
                                            </a>
                                        <?php endif; ?>
                                    </div>
