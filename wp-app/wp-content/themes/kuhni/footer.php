        ...
        <div class="swiper swiper-pick-up">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" data-number="2">
                    ...
                    <p class="subheadline">Укажите длину каждой стены на кухне в сантиметрах. Не обращайте внимание на
                ...
                <div class="swiper-slide" data-number="3">
                    ...
                    <p class="subheadline">Цвет или эмитацию фасада можо выбрать позже. Это не вияется на стоимость</p>
                ...
                <div class="swiper-slide" data-number="6">
                    <div class="form-wrapper">
                        ...
                        <p class="form-subheadline">Наш специалист проверит автоматический расчет цены, скорректирует
