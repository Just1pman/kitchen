...
function create_taxonomy() {
    ...
    register_taxonomy( 'kitchen-category', [ 'kitchens' ], [
        ...
        'labels'                => [
            'name'              => 'Категория кухнь',
            'singular_name'     => 'Категории кухнь',
            'search_items'      => 'Найти категорию кухни',
            'all_items'         => 'Все категории кухнь',
            'view_item '        => 'Просмотреть категорию кухнь',
