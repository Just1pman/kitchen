...
$technicsPost = get_page_by_path( 'technics' );
$discountPost = get_page_by_path( 'discount' );
            ...
            <div class="container">
                <div class="header-bottom-wrapper">
                    ...
                    <div class="header-bottom-center">
                        ...
                        <a href="<?= home_url() ?>/<?= $technicsPost?->post_name ?? '' ?>" class="header-center-tech">
                            ...
                            <p><?= $technicsPost?->post_title ?? '' ?></p>
                        </a>
                        <a href="<?= home_url() ?>/accessories" class="header-center-accessories">
                        ...
                        <a href="<?= home_url() ?>/discount" class="header-center-stock">
